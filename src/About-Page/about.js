...
function blueTheme() {
  ...
  document.documentElement.style.setProperty(
    "--TitleBg",
    "-webkit-gradient(linear, left top, right top, from(#fffe3f), to(#fec212))"
  );
  ...
  document.getElementById("SonicTeam").src =
    "https://upload.wikimedia.org/wikipedia/pt/thumb/9/97/Sonic_Team_Logo.svg/1280px-Sonic_Team_Logo.svg.png";
